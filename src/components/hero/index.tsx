  ...
  return (
    ...
    >
      <div class="relative min-h-screen w-full">
        <img
          src={backgroundImage}
          srcset={`${backgroundImageMobile} 900w, ${backgroundImage} 1920w`}
        ...
        <div class="relative z-10 mx-4 mt-6 flex min-h-screen flex-col items-center justify-center px-4 pt-10 pb-12 text-center sm:px-6 sm:pt-16 sm:pb-20">
          <div class="group mb-6 flex items-center rounded-full border border-white/30 bg-white/20 px-6 py-3 text-white backdrop-blur-sm transition-all duration-300 sm:px-8 sm:py-4">
