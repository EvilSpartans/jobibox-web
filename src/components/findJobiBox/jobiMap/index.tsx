...
import { regionsData } from "~/utils/findJobiboxCities";

interface ModalFindJobiBoxProps {
  isOpen: Signal<boolean>;
}

export const JobiMap = component$<ModalFindJobiBoxProps>(({ isOpen }) => {
  ...
  const getRegionFill = (regionId: string) => {
    if (selectedRegion.value === regionId) return "#09151B";
    if (hoveredRegion.value === regionId) return "#753985";
    return "#e5e7eb";
  };

  const getRegionStroke = (regionId: string) => {
    if (selectedRegion.value === regionId) return "#2E104E";
    return "#374151";
  };
...
>
  ...
  <div class="relative flex max-h-[90vh] w-full max-w-7xl flex-col overflow-hidden rounded-2xl bg-gradient-to-b from-white via-[#fdf9ff] to-[#f3ecff] shadow-[0_0_40px_rgba(0,0,0,0.2)] backdrop-blur-lg border border-white/40">
    {/* Header */}
    <div class="relative rounded-t-2xl bg-gradient-to-r from-[#4a4199] via-[#753985] to-[#9456ED] p-5 sm:p-7 md:p-8 shadow-md">
      <div class="absolute inset-0 bg-white/10 backdrop-blur-[2px] rounded-t-2xl pointer-events-none"></div>
      <div class="flex-1 text-center text-white relative z-10">
        <h2 class="text-2xl font-bold sm:text-3xl">Trouvez une JobiBox</h2>
      ...
      <button
        type="button"
        aria-label="Fermer"
        class="absolute top-3 right-3 flex items-center justify-center rounded-full bg-white/15 hover:bg-white/25 backdrop-blur-sm text-white transition-all p-2 sm:p-2.5 focus:outline-none shadow-inner"
        onClick$={closeModal}
      >
        ✕
      </button>
    ...
    <div class="max-h-[calc(90vh-120px)] overflow-y-auto">
      <div class="flex flex-col md:flex-row">
        {/* Carte SVG */}
        <div class="flex-1 p-4 sm:max-w-[800px]">
          <svg
            preserveAspectRatio="xMidYMid meet"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 612 585"
            class="h-auto max-h-[450px] w-full sm:max-h-[520px] md:max-h-[620px] drop-shadow-lg"
          >
              {/* Alsace-Champagne-Ardenne-Lorraine */}
                <path
                  ...
                  fill={getRegionFill("A")}
                  stroke={getRegionStroke("A")}
                  stroke-width="2"
                  class="cursor-pointer transition-all duration-200"
                  onClick$={() => handleRegionClick("A")}
                  onMouseEnter$={() => handleRegionHover("A")}
                ...
                <path
                  ...
                  fill={getRegionFill("B")}
                  stroke={getRegionStroke("B")}
                  stroke-width="2"
                  class="cursor-pointer transition-all duration-200"
                  onClick$={() => handleRegionClick("B")}
                  onMouseEnter$={() => handleRegionHover("B")}
                  onMouseLeave$={handleRegionLeave}
                />
                ...
                <path
                  ...
                  fill={getRegionFill("C")}
                  stroke={getRegionStroke("C")}
                  stroke-width="2"
                  class="cursor-pointer transition-all duration-200"
                  onClick$={() => handleRegionClick("C")}
                  onMouseEnter$={() => handleRegionHover("C")}
                  onMouseLeave$={handleRegionLeave}
                />
                ...
                <path
                  ...
                  fill={getRegionFill("D")}
                  stroke={getRegionStroke("D")}
                  stroke-width="2"
                  class="cursor-pointer transition-all duration-200"
                  onClick$={() => handleRegionClick("D")}
                  onMouseEnter$={() => handleRegionHover("D")}
                  onMouseLeave$={handleRegionLeave}
                />
                ...
                <path
                  ...
                  fill={getRegionFill("E")}
                  stroke={getRegionStroke("E")}
                  stroke-width="2"
                  class="cursor-pointer transition-all duration-200"
                  onClick$={() => handleRegionClick("E")}
                  onMouseEnter$={() => handleRegionHover("E")}
                  onMouseLeave$={handleRegionLeave}
                />
                ...
                <path
                  ...
                  fill={getRegionFill("F")}
                  stroke={getRegionStroke("F")}
                  stroke-width="2"
                  class="cursor-pointer transition-all duration-200"
                  onClick$={() => handleRegionClick("F")}
                  onMouseEnter$={() => handleRegionHover("F")}
                  onMouseLeave$={handleRegionLeave}
                />
                ...
                <path
                  ...
                  fill={getRegionFill("G")}
                  stroke={getRegionStroke("G")}
                  stroke-width="2"
                  class="cursor-pointer transition-all duration-200"
                  onClick$={() => handleRegionClick("G")}
                  onMouseEnter$={() => handleRegionHover("G")}
                  onMouseLeave$={handleRegionLeave}
                />
                ...
                <path
                  ...
                  fill={getRegionFill("H")}
                  stroke={getRegionStroke("H")}
                  stroke-width="2"
                  class="cursor-pointer transition-all duration-200"
                  onClick$={() => handleRegionClick("H")}
                  onMouseEnter$={() => handleRegionHover("H")}
                  onMouseLeave$={handleRegionLeave}
                />
                ...
                <path
                  ...
                  fill={getRegionFill("I")}
                  stroke={getRegionStroke("I")}
                  stroke-width="2"
                  class="cursor-pointer transition-all duration-200"
                ...
                <path
                  ...
                  fill={getRegionFill("J")}
                  stroke={getRegionStroke("J")}
                  stroke-width="2"
                  class="cursor-pointer transition-all duration-200"
                  onClick$={() => handleRegionClick("J")}
                  onMouseEnter$={() => handleRegionHover("J")}
                  onMouseLeave$={handleRegionLeave}
                />
                ...
                <path
                  ...
                  fill={getRegionFill("K")}
                  stroke={getRegionStroke("K")}
                  stroke-width="2"
                  class="cursor-pointer transition-all duration-200"
                  onClick$={() => handleRegionClick("K")}
                  onMouseEnter$={() => handleRegionHover("K")}
                  onMouseLeave$={handleRegionLeave}
                />
                ...
                <path
                  ...
                  fill={getRegionFill("L")}
                  stroke={getRegionStroke("L")}
                  stroke-width="2"
                  class="cursor-pointer transition-all duration-200"
                  onClick$={() => handleRegionClick("L")}
                  onMouseEnter$={() => handleRegionHover("L")}
                  onMouseLeave$={handleRegionLeave}
                />
                ...
                <path
                  ...
                  fill={getRegionFill("M")}
                  stroke={getRegionStroke("M")}
                  stroke-width="2"
                  class="cursor-pointer transition-all duration-200"
                  onClick$={() => handleRegionClick("M")}
                  onMouseEnter$={() => handleRegionHover("M")}
                  onMouseLeave$={handleRegionLeave}
                />
          </svg>
        </div>
        ...
        {/* Panneau infos */}
        <div class="w-full p-5 sm:w-96 sm:p-7 lg:w-[400px] bg-white/70 backdrop-blur-md border-l border-[#4a4199]/20">
          <div class="sticky top-4">
            {selectedRegion.value ? (
              <div>
                <h4 class="mb-3 text-xl font-bold text-[#2E104E] sm:text-2xl">
                  {
                    regionsData[
                      selectedRegion.value as keyof typeof regionsData
                    ]?.name
                  }
                </h4>
                <div>
                  <h5 class="mb-2 text-xl font-semibold text-[#2E104E]">
                    Villes équipées :
                  </h5>
                  {regionsData[
                    selectedRegion.value as keyof typeof regionsData
                  ]?.cities?.length ? (
                    <ul class="space-y-1 text-xl max-h-64 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-[#753985]/50 scrollbar-track-transparent hover:scrollbar-thumb-[#753985]/70 transition-all">
                      {regionsData[
                        selectedRegion.value as keyof typeof regionsData
                      ]?.cities.map((city, index) => (
                        <li
                          key={index}
                          class="flex items-center text-[#2E104E]"
                        >
                          <div class="mr-2 h-2 w-2 rounded-full bg-[#2E104E]"></div>
                          {city}
                        </li>
                      ))}
                    </ul>
                  ) : (
                    <p class="text-xl text-[#2E104E]/70 italic">
                      Aucune ville équipée pour cette région.
                    </p>
                  )}
                </div>
              </div>
            ) : (
              <div class="text-xl text-[#2E104E] sm:text-2xl text-center italic opacity-70">
            ...
            {hoveredRegion.value &&
              hoveredRegion.value !== selectedRegion.value && (
                <div class="mt-4 hidden rounded-lg p-3 sm:block">
                  <p class="text-2xl text-[#2E104E]">
                    <span class="font-medium">
                      {
                        regionsData[
                          hoveredRegion.value as keyof typeof regionsData
                        ]?.name
                      }
                    </span>
                  </p>
                  <p class="mt-1 text-xl text-[#2E104E]">
