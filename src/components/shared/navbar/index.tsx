...
>
      ...
      <ul class="hidden flex-wrap items-center gap-6 font-medium text-white md:flex">
        <li><a href="#jobibox" class="hover:text-[#9456ED]">La JobiBox</a></li>
        <li><a href="#features" class="hover:text-[#9456ED]">Fonctionnalité</a></li>
        <li><a href="#technology" class="hover:text-[#9456ED]">Technologie</a></li>
        <li><a href="#recruiter" class="hover:text-[#9456ED]">Recruteur</a></li>
        <li><a href="#findJobiBox" class="hover:text-[#9456ED]">Trouve une JobiBox</a></li>
        <li><a href="#jobiTruck" class="hover:text-[#9456ED]">JobiTruck</a></li>
        <li><a href="#faq" class="hover:text-[#9456ED]">FAQ</a></li>
      </ul>

      <a href="#jobibox" class="hidden md:flex">
        <WhiteButton label="Découvrir la jobibox" onClick$={() => console.log("Clic!")} />
      </a>
