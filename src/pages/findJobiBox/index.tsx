  ...
  ({ isOpen }) => {
    ...
    const regionsData = {
      A: {
        ...
        cities: ["Strasbourg", "Metz", "Reims", "Nancy", "Troyes"],
      },
      B: {
        name: "Aquitaine-Limousin-Poitou-Charentes",
        cities: ["Bordeaux", "Limoges", "Poitiers", "La Rochelle", "Périgueux"],
      },
      C: {
      ...
      D: {
        ...
        cities: ["Dijon", "Besançon", "Auxerre", "Mâcon", "Belfort"],
      },
      E: {
        name: "Bretagne",
        cities: ["Rennes", "Brest", "Quimper", "Saint-Brieuc", "Vannes"],
      },
      F: {
        name: "Centre-Val de Loire",
        cities: ["Orléans", "Tours", "Bourges", "Blois", "Châteauroux"],
      },
      G: {
        name: "Corse",
      ...
      H: {
        name: "Île-de-France",
        cities: ["Paris", "Versailles", "Nanterre", "Créteil", "Pontoise"],
      },
      I: {
        name: "Occitanie",
        cities: ["Toulouse", "Montpellier", "Perpignan", "Nîmes", "Béziers"],
      },
      J: {
        name: "Nord-Pas-de-Calais-Picardie",
        cities: ["Lille", "Amiens", "Calais", "Arras", "Beauvais"],
      },
      K: {
        name: "Normandie",
        cities: ["Rouen", "Caen", "Le Havre", "Cherbourg", "Évreux"],
      },
      L: {
        name: "Pays de la Loire",
        cities: ["Nantes", "Angers", "Le Mans", "Laval", "Saint-Nazaire"],
      },
      M: {
        name: "Provence-Alpes-Côte d'Azur",
        cities: ["Marseille", "Nice", "Toulon", "Avignon", "Cannes"],
      },
    };
    ...
    return (
      ...
      >
        <div
          ...
          onClick$={closeModal}
        />
        <div class="relative flex max-h-[90vh] w-full max-w-7xl flex-col overflow-hidden rounded-xl bg-white shadow-2xl">
          <div class="rounded-t-xl bg-gradient-to-b from-[#4a4199] to-[#753985] p-4 sm:p-6 md:p-7">
            <div class="flex-1 text-center text-white">
              ...
              <p class="sm:text-xl mt-2 opacity-90">
            ...
            <button
              type="button"
              aria-label="Fermer"
              class="absolute top-2 right-2 rounded-md bg-[#2E104E] p-1.5 text-white focus:outline-none sm:top-3 sm:right-3 sm:p-2"
              onClick$={closeModal}
            >
              ✕
            </button>
            ...
            <div class="flex flex-col md:flex-row">
              ...
              <div class="flex-1 p-4 sm:max-w-[800px]">
                <svg
                  ...
                  viewBox="0 0 612 585"
                  class="h-auto max-h-[400px] w-full sm:max-h-[500px] md:max-h-[600px]"
                >
                  ...
                  <path
                    ...
                    fill={getRegionFill("N")}
                    stroke={getRegionStroke("N")}
                    stroke-width="2"
                    class="cursor-pointer transition-all duration-200"
                    onClick$={() => handleRegionClick("N")}
                    onMouseEnter$={() => handleRegionHover("N")}
                    onMouseLeave$={handleRegionLeave}
                  />
                </svg>
              </div>
              ...
              <div class="w-full p-4 sm:w-96 sm:p-6 lg:w-96">
                <div class="sticky top-4">
                  {selectedRegion.value ? (
                    ...
                    <div class="text-xl text-[#2E104E] sm:text-2xl">
